...
export const LiveNotificationToast = ({ notification, onClose }) => {
  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 max-w-sm w-full animate-in slide-in-from-bottom-5 fade-in duration-200">
      <div className="p-4 rounded-2xl bg-slate-900/95 border border-medicover-500/40 shadow-2xl backdrop-blur-md flex items-start gap-3">
        ...
        <div className="flex-1">
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-bold uppercase tracking-wider text-medicover-400 font-mono">
              Live DB Event: {notification.table}
            </span>
