...
from app.routes import auth, beds, stays, billing, labs, conflicts, activity, dashboard, websocket, requisitions, equipments, hospitals, doctors, appointments, sensors
